...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function saveOptions() {
    ...
    chrome.storage.sync.set({
      ...
      status.textContent = "Options saved with ".concat(defaultPage);
      setTimeout(function () {
        status.textContent = '';
      }, 3000);
    });
  ...
  function restoreOptions() {
    ...
    chrome.storage.sync.get({
      ...
      document.getElementById('saved-setting').textContent = "<p>Default theme: <strong>".concat(items.loadDefaultPage, "</strong>.</p>");
    });
  }
...
module.exports = __webpack_require__(/*! /Users/liammerlyn/Development.nosync/StoreExplorer/src/options.js */"./src/options.js");
