    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default.a.ajax({
      ...
      success: function success(shops) {
        ...
        shopDetails = {
          ...
          createdAt: date_fns_format__WEBPACK_IMPORTED_MODULE_2___default()(shopArr.created_at, 'DD-MM-YYYY'),
          lastUpdated: date_fns_format__WEBPACK_IMPORTED_MODULE_2___default()(shopArr.updated_at, 'DD-MM-YYYY')
        };
        location = {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('[data-panel="active"]').append(shopAccordion).append(locationAccordion).append(currencyAccordion).append(jsonAccordion);
      },
      error: function error(xhr, status, _error) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.Popup__Header').hide();
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('[data-panel="active"]').empty().append(errorMessage);
      }
    });
  });
});
    ...
    jquery__WEBPACK_IMPORTED_MODULE_2___default.a.ajax({
      ...
      success: function success(themes, response) {
        ...
        for (var i = 0; i < themeArr.length; i++) {
          var themePreviewUrl = "http://".concat(shop.domain, "/?preview_theme_id=").concat(themeArr[i].id);
          var theme = {
