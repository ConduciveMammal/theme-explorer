    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      ...
      success: function (shops) {
        ...
        shopDetails = {
          ...
          createdAt: date_fns_format__WEBPACK_IMPORTED_MODULE_1___default()(shopArr.created_at, 'DD-MM-YYYY'),
          lastUpdated: date_fns_format__WEBPACK_IMPORTED_MODULE_1___default()(shopArr.updated_at, 'DD-MM-YYYY')
        };
        location = {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-panel="active"]').append(shopAccordion).append(locationAccordion).append(currencyAccordion).append(jsonAccordion);
      },
      error: function () {
        console.log('Ah tits!');
      }
      ...
      success: function (themes) {
        ...
        for (let i = 0; i < themeArr.length; i++) {
          ...
          let theme = {
            ...
            createdAt: date_fns_format__WEBPACK_IMPORTED_MODULE_1___default()(themeArr[i].created_at, 'DD-MM-YYYY'),
            lastUpdated: date_fns_format__WEBPACK_IMPORTED_MODULE_1___default()(themeArr[i].updated_at, 'DD-MM-YYYY')
          };
          let themeAccordion = `
          <div class="Accordion__Container">
          <header class="Accordion__Header" data-accordion-toggle>
...
/* harmony import */ var _js_modules_preload__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/modules/preload */ "./src/js/modules/preload.js");
/* harmony import */ var _js_modules_themes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/modules/themes */ "./src/js/modules/themes.js");
/* harmony import */ var _js_modules_shop__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/modules/shop */ "./src/js/modules/shop.js");
...
document.addEventListener('DOMContentLoaded', function () {
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.Nav__Button').click(function () {
    let thisTab = jquery__WEBPACK_IMPORTED_MODULE_1___default()(this);
    ...
    if (tabData == 'themes') {
      ...
      Object(_js_modules_shop__WEBPACK_IMPORTED_MODULE_5__["default"])(); // alert('shop')
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()('body').on('click', 'a[target="_blank"]', function (e) {
  e.preventDefault();
  chrome.tabs.create({
    url: jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).prop('href'),
    active: false
  });
  return false;
});
  ...
  chrome.tabs.getSelected(null, function (tab) {
    ...
    if (isAdmin) {
      ...
      if (adminDir == 'themes') {
        ...
        Object(_js_modules_shop__WEBPACK_IMPORTED_MODULE_5__["default"])();
