...
chrome.tabs.getSelected(null, function (tab) {
  ...
  if (tabUrl.includes(permUrl)) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default.a.getJSON(themeUrl, function (themes) {
      ...
      for (let i = 0; i < themeArr.length; i++) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('#products').append(cardHeaderActions);
      }
    });
  } else {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#products').append(skeletonCard);
  }
});
